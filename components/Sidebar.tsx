    ...
    return (
        <div className="flex flex-col px-4 py-2 font-medium text-center font-montserrat md:text-sm">
            ...
            <div className="flex justify-center w-9/12 mx-auto my-6 transition duration-300 text-ming md:w-full dark:text-white">
                <a target="_blank" href="https://github.com/gfirik" rel="noopener noreferrer" className="transition duration-100 transform hover:-translate-y-1">
                    <AiFillGithub className="w-10 h-10 mx-4 cursor-pointer"/>
                </a>
                <a target="_blank" href="https://www.linkedin.com/in/firdavs-gafurjonov/" rel="noopener noreferrer" className="transition duration-100 transform hover:-translate-y-1">
            ...
            <div className="flex flex-col items-center w-full">    
                <button 
                    ...
                    onClick={() => window.open("mailto:firdavs.gafurjonov@gmail.com?subject=Mail from Porfolio")}
                >
                    Contact Me
                </button>
                <button 
